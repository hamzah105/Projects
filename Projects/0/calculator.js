...
function calculator() {
    ...
    getNumber('Enter the first number: ', function (num1) {
        getNumber('Enter the second number: ', function (num2) {
            console.log('Select an operation:');
            console.log('1. Add');
            console.log('2. Subtract');
            console.log('3. Multiply');
            console.log('4. Divide');
            rl.question('Enter the operation (1/2/3/4): ', function (operation) {
                switch (operation) {
                    case '1':
